    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>">Aplikasi Ujian Online</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                ...
                                <div>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eleifendassets.</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="<?php echo base_url('jurusan'); ?>">Data Jurusan</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="<?php echo base_url('soal'); ?>"><i class="fa fa-book fa-fw"></i> Soal</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('ujian'); ?>"><i class="fa fa-edit fa-fw"></i> Hasil Ujian</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
